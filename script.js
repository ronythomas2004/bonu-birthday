...
const CONFIG = {
  ...
  captions: [
    "after the day 0 train journey", "our 1st meetup aftr", "Hehe..just cropped", "that anointing day",
    "the Chosen", "My smile starts from here", "aftr that iconic diori ride", "hmmmm",
    "that unforgettable beach day", "my fav pic of us 💛🩵"
  ],
  childhoodCaptions: [
    "tiny Boni", "before I knew you", "look at her", "young legend",
    "the beginning", "future best friend", "so small", "iconic even then"
  ],

  /* Custom messages for each of the 42 childhood photos */
  childhoodMessages: [
    "Look at tiny Boni! Legendary from day one. 🩵",
    "A rare glimpse into the kid who became my best friend.",
    "Samshayam onnum illalo le",
    "Uff siree... aa chiri",
    "Before any of our inside jokes even existed.",
    "Bharat mata ki jey.",
    "A little thumbs up.",
    "Already iconic",
    "Look at that smile! Honestly hasn't changed a bit.",
    "Hehe",
    "Wow...Bonu with pottu..looking cute",
    "Proof that you've been hilarious since day 1.",
    "Little Boni making big memories.",
    "The beginning of everything.",
    "Look at those tiny cheeks!",
    "A classic throwback photo.",
    "Already breaking all the rules even back then.",
    "Unfiltered childhood joy right here.",
    "The cutest photo in the entire archive.",
    "Look at her go! Natural born legend.",
    "Before the late night texts and emergency calls.",
    "Living her best life as a kid.",
    "The main character since day one.",
    "Honestly, this photo deserves a trophy.",
    "Little did you know you'd meet me years later!",
    "Sweet childhood memories.",
    "Always bringing the best energy.",
    "Look at that mischievous look in her eyes!",
    "Timeless Boni memory.",
    "Pure childhood magic.",
    "Another iconic childhood moment.",
    "The sweetest throwback.",
    "Look at you! Unstoppable even then.",
    "Unforgettable kid picture.",
    "Precious memory from the archives.",
    "Always smiling, always shining.",
    "Look at her style! Trendsetter early on.",
    "A moment frozen in time.",
    "Living life with zero worries.",
    "Proof of how fast time flies.",
    "The kid who grew up to mean so much to me.",
    "42 photos of the kid who became my favorite person. 🩵"
  ],
  ...
  quotes: [
    ...
    "“Some people go to priests, others to poetry. I go to my best friend.”",
